...
searchInput.addEventListener("input", () => {
    ...
    const filtered = columns.filter(col => col.toLowerCase().startsWith(value) && !selectedSymptoms.includes(col));
...
form.addEventListener("submit", (e) => {
    ...
    .then(result => {
        ...
        <span style="color: #00ffff; font-weight:bold;">Predicted Disease:</span> 
        <br>
        <span style="color: #aad6ffff; font-size:1.5em; text-shadow:2px -2px 0 #0000ff,">${result.prediction}</span>
